...
class AbstractOutput {
    ...
    setPwm(pinObject, value) {
        ...
        if (!this.isConnected) {
            this.queue.push(this._setPwm.bind(pinId, value));
    ...
    setDigital(pinObject, value) {
        ...
        if (!this.isConnected) {
            this.queue.push(this._setDigital.bind(pinId, value));
    ...
    setAnalog(pinObject, value) {
        ...
        if (!this.isConnected) {
            this.queue.push(this._setAnalog().bind(pinId, value));
    ...
    _setDigital(pinId, value) {
        throw "_setPwm is not implemented";
    };

    _setAnalog(pinId, value) {
        throw "_setPwm is not implemented";
    };
}
